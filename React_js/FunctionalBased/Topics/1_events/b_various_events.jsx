...
// various events 
// {   
//     onclick, onDoubleClick, onChange,
//     onKeyUp, onKeyDown,
//     onMouseOver, onMouseEnter, onMouseLeave, onMouseDown
//     onFocus, onBlur,
...
const EventListenerDemo = () => {
  ...
  return (
    <div>
      ...
      <input
        type="text"
        onKeyDown={handleKeyDown} // see this function to see how to submit data on enter key pressed
        onKeyUp={handleKeyUp}
        onFocus={handleFocus}
